# <div style="text-align:center; display: flex; justify-content: center; gap: 15px;">frontEnd-Day-app <img src="./public/assets/logos/logo-open-rage.svg" style="width: 30px; height: 30px padding: 5px; background-color: #fff; border-radius: 50%;"></div>
